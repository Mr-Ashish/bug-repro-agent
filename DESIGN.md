...
- **Phase 1 (Author):** Claude Code reasons about the bug, drives the browser via Stagehand, and compiles everything into deterministic artifacts. Expensive, once per bug.
